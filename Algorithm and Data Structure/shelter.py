...
class AnimalShelter(object):
    ...
    def __init__(self,user,password):
        ...
        self.client = MongoClient('mongodb://%s:%s@localhost:52428'%(user,password))
    ...
    # this method will receive a dictionary, find all items that math the dictionary 
    ...
    # this method update using the id of the collection, one can also update using any key
